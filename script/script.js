        ...
        var template = {
            TRAIN_RESULT: [
                '<div class="train-row" data-train-no="${train_no}">',
                    ...
                    '</div>',
                    '<div class="note">',
                        '<div class="bicycle"><img src="https://maxcdn.icons8.com/office/PNG/40/Transport/bicycle-40.png" title="自行車" width="20"></div>',
                        '<div class="wheelchair"><img src="https://maxcdn.icons8.com/Color/PNG/48/Healthcare/wheelchair-48.png" title="身障座位" width="20"></div>',
                        '<div class="breastfeeding"><img src="https://maxcdn.icons8.com/Color/PNG/48/Baby/breastfeeding-48.png" title="哺乳室" width="20"></div>',
                        '<div class="overnight"><img src="https://maxcdn.icons8.com/Color/PNG/48/Astrology/waning_gibbous-48.png" title="跨夜" width="20"></div>',
                    '</div>',
